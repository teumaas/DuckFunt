...
namespace SpaceHuntClasses.Shapes
{
    class LoadScreen : IScreen
    {
        ...
        public void Initialize(GraphicsInfos graphics)
        {
            ...
            runnerShape.ResizeWithTexture(graphics.resolution);
            runnerShape.ApplyPositionPercentage(graphics.resolution);
            ...
            firstPlanetShape.ResizeWithTexture(graphics.resolution);
            firstPlanetShape.ApplyPositionPercentage(graphics.resolution);
            ...
            secondPlanetShape.ResizeWithTexture(graphics.resolution);
            secondPlanetShape.ApplyPositionPercentage(graphics.resolution);
            secondPlanetShape.rectangle.X -= secondPlanetShape.rectangle.Width;
