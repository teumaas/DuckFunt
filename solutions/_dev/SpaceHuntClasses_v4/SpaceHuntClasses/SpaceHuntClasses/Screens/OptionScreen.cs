...
namespace SpaceHuntClasses.Screens
{
    ...
    public class OptionScreen : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public OptionScreen(Main main, GraphicsInfos graphics) : base(main)
        {
            ...
            messageBox = new MessageBoxResolution(graphics, main.fontSize10);
        }
        ...
        public void Initialize(GraphicsInfos graphics)
        {
            ...
            buttonOptionAudio = new ButtonOption(graphics, audioButtonTexture, new Rectangle(5, 20, 0, 0));
            buttonOptionVideo = new ButtonOption(graphics, videoButtonTexture, new Rectangle(15, 35, 0, 0));
            buttonOptionControl = new ButtonOption(graphics, controlsButtonTexture, new Rectangle(7, 55, 0, 0));
            ...
            var b1 = new ButtonCheckBoxResolution(graphics, resolutionTexture_1920_1080, new Rectangle(40, 15, 15, 15), currentResolution.width == 1920, new Resolution(1920, 1080));
            var b2 = new ButtonCheckBoxResolution(graphics, resolutionTexture_800_600, new Rectangle(40, 30, 45, 25), currentResolution.width == 800, new Resolution(800, 600));
            b1.Release += ResolutionButtonOnRelease;
            b2.Release += ResolutionButtonOnRelease;
            resolutionButtons.Add(b1);
            resolutionButtons.Add(b2);

            musicButton = new ButtonCheckBox(graphics, musicButtonTexture, new Rectangle(40, 15, 0, 0), true);
            specialeffectButton = new ButtonCheckBox(graphics, specialEffectsButtonTexture, new Rectangle(40, 30, 0, 0), true);
            soundButton = new ButtonCheckBox(graphics, soundButtonTexture, new Rectangle(40, 45, 0, 0), true);
            ...
            wiimoteTrackBar = new ButtonTrackBar(graphics, main.trackBarTexture, new Rectangle(40, 15, 0, 0), main.fontSize10, main.scrollTrackBarTexture, "wiimote", 5);
            mouseTrackBar = new ButtonTrackBar(graphics, main.trackBarTexture, new Rectangle(40, 35, 0, 0), main.fontSize10, main.scrollTrackBarTexture, "mouse", 5);
            wiimoteTrackBar.Release += WiimoteTrackBarOnRelease;
            mouseTrackBar.Release += MouseTrackBarOnRelease;

            windowShape = new Shape(graphics, windowTexture, new Rectangle(40, 15, 0, 0));
            boardShape = new Shape(graphics, boardTexture, new Rectangle(0, 15, 0, 0));
            blindShape = new ShapeSource(graphics, blindTexture, new Rectangle(40, 15, 0, 0));
            projectorShape = new Shape(graphics, projectorTexture, new Rectangle(40, 15, 0, 0));

            fullScreenButton = new ButtonCheckBox(graphics, fullscreenTexture, new Rectangle(0, 0, 0, 0), main.graphics.IsFullScreen);
