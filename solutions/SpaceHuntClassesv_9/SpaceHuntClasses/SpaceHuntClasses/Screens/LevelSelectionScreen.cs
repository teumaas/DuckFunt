...
namespace SpaceHuntClasses.Screens
{
    ...
    class LevelSelectionScreen : IScreen
    {
        ...
        public void Initialize(GraphicsInfos graphics)
        {
            ...
            easyButton.rectangle = new Rectangle(100, 100, 100, 50);
            ...
            //mediumButton.rectangle = new Rectangle(150, 100, 100, 50);
            ...
            for(int i = 0; i < levels.Count();i++)
            {
                ...
                {
                    unlockedLevels.Add(new ButtonLevel(graphics, GetLevelsTexture()[i], new Rectangle(0, 0, 0, 0), levels[i], b, main.fontSize14, main.fontSize10));
