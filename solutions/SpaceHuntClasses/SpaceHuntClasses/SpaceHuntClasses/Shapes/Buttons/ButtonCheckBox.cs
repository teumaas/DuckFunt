...
{
    public class ButtonCheckBox : ShapeInteractive
    {
        ...
        public ButtonCheckBox(Texture2D texture, Rectangle rectangle, bool selected)
            : base(texture, rectangle)
        {
            sourceRectangle = new Rectangle(0, 0, texture.Bounds.Width, texture.Bounds.Height /2);
